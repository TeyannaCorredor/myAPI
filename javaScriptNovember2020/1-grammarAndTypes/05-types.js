...
/*
Null and undefined both represent variables with no value inside. Think of it this way--null values are for gag gifts
that are boxes intentionally given with nothing inside (because that's the gag).
Undefined values are gifts given when the person giving the gift has fogotten to put the gift 
inside.(oops!)
*/
...
(it can hold muultiple date types)

Denoted by {}
Have keys and values--color (key): 'blue' (value), separted with a colon, each key-value
pair is separated with a comma
*/
